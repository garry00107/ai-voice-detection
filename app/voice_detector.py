...
class VoiceDetector:
    ...
    def detect(self, features: Dict[str, Any], audio: np.ndarray = None, sr: int = None, audio_bytes: bytes = None) -> Dict[str, Any]:
        """
        ...
        if classification == "AI_GENERATED":
            ...
            explanation = f"AI voice detected: {', '.join(patterns[:3])}. Ensemble confidence: {confidence:.0%} across {len(methods_used)} models"
        else:
